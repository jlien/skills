...
### Writing System (Orwell's Rules)

Apply these six rules from George Orwell's "Politics and the English Language" (1946) to all written output — READMEs, PR descriptions, landing pages, docs, and any public-facing text:
...
Positive instructions work better than negative bans — these rules are a framework the AI can apply, while "don't sound like AI" is a vague prohibition. Rule 6 (the escape clause) prevents the system from becoming pedantic or robotic.
...
- Tony Simons, "SOUL.md" — operating contract for autonomous agents ([@tonysimons\_](https://x.com/tonysimons_/status/2056545463713640917))
- George Orwell, "Politics and the English Language" (1946) — writing system rules ([@Voxyz_ai](https://x.com/voxyz_ai/status/2078857039116156978))